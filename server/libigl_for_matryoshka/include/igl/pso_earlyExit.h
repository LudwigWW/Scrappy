#ifndef IGL_PSO_earlyExit_H
#define IGL_PSO_earlyExit_H
...
namespace igl
{
  ...
  //   subject to lb ≤ x ≤ ub 
  // 
  // by particle swarm optimization (pso_earlyExit).
  //
  // Inputs:
  ...
  template <
    ...
    typename DerivedLB, 
    typename DerivedUB>
  IGL_INLINE Scalar pso_earlyExit(
