...
#ifndef IGL_COPYLEFT_CGAL_MINKOWSKI_SUM_POINT_H
#define IGL_COPYLEFT_CGAL_MINKOWSKI_SUM_POINT_H
  ...
  namespace copyleft
  {
    namespace cgal
    {
      ...
      template <
        ...
        typename DerivedG,
        typename DerivedJ>
      IGL_INLINE void minkowski_sum_point(
...
#  include "minkowski_sum_point.cpp"
#endif
