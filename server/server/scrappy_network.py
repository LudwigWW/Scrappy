...
def network_receive_file(base_path_fo_file, file_name, file_size, file_host, file_port):
    ...
    try:
        ...
        print(str(e))
    file_skt.listen(10) # Accepts only 1 connection. # 10 as a safeguard against connections from the internet taking up the space, which we hope to block with the firewall
...
def network_send_file(base_path_fo_file, file_name, file_host, file_port):
    ...
    # print(base_path_fo_file + file_name + ": File opened: " + str(file_to_send.fileno()))
