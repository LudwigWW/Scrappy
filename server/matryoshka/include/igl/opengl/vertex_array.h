...
namespace igl
{
  namespace opengl
  {
    ...
    //
    // Note: Unlike most libigl functions, the **input** Eigen matrices must be
    // `Eigen::PlainObjectBase` because we want to directly access it's underlying
    // storage. It cannot be `Eigen::MatrixBase` (see
