bl_info = {
    "name": "Scrappy Find Object Bounding Box",
    "author": "Ludwig Wilhelm Wall, Patrick R. Moore",
    "version": (1, 0, 0),
    "blender": (2, 80, 0),
    "location": "View3D > Add > Mesh > New Object",
    "description": "Adds new cube approximating minumum bounding box",
    "warning": "",
    "wiki_url": "",
...
def bbox_orient(bme_verts, mx):
    '''
    takes a lsit of BMverts or a list of vectors
    '''
    # print(bme_verts)
    # print(mx)
    # print(hasattr(bme_verts[0], 'co'))
    # print(bme_verts[0])
    # print(bme_verts[0].co)
    # print(mx @ bme_verts[0].co)
...
def main_SVD(context, down_sample, method, spin_res, make_box):
    ...
    for n in range(0, 2 * spin_res):
        ...
        if method == 'pca_x':  #keep x axis and rotate around it
            ...
            #Keep Z
            rmx[2][0], rmx[2][1], rmx[2][2] = Z[0], Z[1], Z[2]
        else: # Test all three, start with X
            rmx[0][0], rmx[0][1], rmx[0][2] = X[0], X[1], X[2]
...
class ObjectMinBoundBox(bpy.types.Operator):
    ...
    method_enum = [('brute_force', "BRUTE FORCE", 'Checks a bunch of random boxes'),
                   ...
                   ('pca', 'PCALL', 'Good for most things')]
